...
const Timeline= () => {
  ...
  return (
    <div className="bg-secondary-content border-4 mt-0.5 rounded-2xl mr-0.5 ml-0.5 overflow-x-auto">
        ...
        {timelineData.map((item, index) => (
          <div key={index} className="flex items-center">
            ...
            <div className="w-16 flex-none items-center">
              {/* Product Box */}
              <div className=" w-16 h-8 py-2 bg-black text-primary-content    rounded-lg shadow-md mb-4   text-center  break-words ">
